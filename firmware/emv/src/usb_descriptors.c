...
ROM USB_DEVICE_DESCRIPTOR device_dsc=
{
    ...
    0x1325,                 // Vendor ID: austriamicrosystems AG
    0xC802,                 // Product ID: AS1130 MCU Board, refer to
...
} sd001=
{
    ...
    {
        'a','u','s','t','r','i','a','m','i','c','r','o','s','y','s','t','e','m','s',' ','A','G'
    }
};
